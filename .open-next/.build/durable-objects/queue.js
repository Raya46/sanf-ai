...
<<<<<<< HEAD
          "x-prerender-revalidate": "69c4db5f06184ca50cb67246c5d42d57",
=======
          "x-prerender-revalidate": "a942c7ce4a99f7a0c75871a632c8c99e",
>>>>>>> a00967360d214f947195a0d53d5093392f448478
      ...
      if (!this.disableSQLite) {
        this.sql.exec(
          ...
          `${host}${url}`,
<<<<<<< HEAD
          "dohRModrYkMaGn-CYLZ9B"
=======
          "Yj9MQuvSjddECtoBXJOKT"
>>>>>>> a00967360d214f947195a0d53d5093392f448478
        );
      }
      this.routeInFailedState.delete(msg.MessageDeduplicationId);
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
<<<<<<< HEAD
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "dohRModrYkMaGn-CYLZ9B");
=======
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "Yj9MQuvSjddECtoBXJOKT");
>>>>>>> a00967360d214f947195a0d53d5093392f448478
    }
    await this.addAlarm();
  }
...
<<<<<<< HEAD
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "dohRModrYkMaGn-CYLZ9B");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "dohRModrYkMaGn-CYLZ9B");
=======
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "Yj9MQuvSjddECtoBXJOKT");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "Yj9MQuvSjddECtoBXJOKT");
>>>>>>> a00967360d214f947195a0d53d5093392f448478
