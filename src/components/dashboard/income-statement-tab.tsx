...
const incomeStatementData: IncomeStatementItem[] = [
  ...
  {
    keterangan: "Penjualan Batu Bara",
    "2024": 65780000000,
    "2023": 52340000000,
  },
  {
    keterangan: "Penjualan Alat Berat",
    "2024": 8920000000,
    "2023": 6750000000,
  },
  ...
  {
    keterangan: "Penyusutan Alat Berat",
    "2024": 5670000000,
    "2023": 4890000000,
  },
  {
    keterangan: "Jumlah Beban Pokok Penjualan",
    "2024": 42610000000,
    "2023": 34910000000,
    isTotal: true,
  },
  ...
  {
    keterangan: "PENDAPATAN (BEBAN) LAIN-LAIN",
    "2024": "",
    "2023": "",
    isHeader: true,
  },
  ...
  {
    keterangan: "Jumlah Pendapatan (Beban) Lain-lain",
    "2024": -3220000000,
    "2023": -2920000000,
    isTotal: true,
  },
...
const IncomeStatementTable: React.FC<{ data: IncomeStatementItem[] }> = ({
  data,
}) => (
